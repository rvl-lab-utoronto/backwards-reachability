...
Below is a straightforward geometric example involving a [Dubin's Car][]{:target="-blank"}, a simple idealized dynamics model for a 2D car. The car can be imagined as a rigid body that moves in the $$xy$$ plane. 
